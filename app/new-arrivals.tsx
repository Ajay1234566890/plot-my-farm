...
const newArrivals = [
  {
    id: 1,
    name: 'Fresh Tomatoes',
    harvestedAgo: '2 days ago',
    image: 'https://example.com/tomatoes.jpg'
  },
  {
    id: 2,
    name: 'Organic Spinach',
    harvestedAgo: '1 week ago',
    image: 'https://example.com/spinach.jpg'
  },
  {
    id: 3,
    name: 'Sweet Corn',
    harvestedAgo: '3 days ago',
    image: 'https://example.com/corn.jpg'
  },
  {
    id: 4,
    name: 'Red Bell Peppers',
    harvestedAgo: '5 days ago',
      ...
      >
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center gap-3">
            ...
            <Text className="text-white text-xl font-bold">New Arrivals</Text>
          </View>
          <TouchableOpacity
            className="w-10 h-10 items-center justify-center rounded-full bg-white/20"
          ...
          >
            <View className="flex-row items-center flex-1">
              ...
              <View className="ml-4 flex-1">
                ...
                <Text className="text-sm text-gray-500">Harvested: {item.harvestedAgo}</Text>
              </View>
              <TouchableOpacity
