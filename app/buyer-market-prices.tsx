    ...
    <View className="flex-1" style={{ backgroundColor: '#F5F3F0' }}>
      ...
      {loading ? (
        <View className="flex-1 items-center justify-center">
          ...
          <Text className="text-gray-500 mt-4">Loading market prices...</Text>
        </View>
                    ...
                    {crop.trend === 'up' ? (
                      <>
                        ...
                        <Text className="text-green-500 text-xs ml-1">
                          {crop.priceChange ? `+${crop.priceChange.toFixed(1)}%` : 'Up'}
                        </Text>
                      </>
                    ) : crop.trend === 'down' ? (
                      <>
                        ...
                        <Text className="text-red-500 text-xs ml-1">
                          {crop.priceChange ? `${crop.priceChange.toFixed(1)}%` : 'Down'}
                        </Text>
                      </>
                    ) : null}
                  </View>
