      ...
      export default function AddOffer() {
        ...
        const handleSubmit = async () => {
          ...
          try {
            ...
            // Refresh offers context if available
            // We can't easily refresh context without a refresh function,
            // but navigation back usually triggers a refetch in the parent list
            // if (offers && addOffer) {
            //    await refreshOffers(); // Assuming refreshOffers exists in context
            // }
